import numpy
import node
import laplacian_anonymous as hidden
...
class Coupling_terms_manager :
    def __init__(self, nodes) :
        self._alphas = hidden.get_alphas_terms(nodes)
        self._betas  = hidden.get_betas_terms(nodes)
        self._gammas = hidden.get_gammas_terms(nodes)
        self._deltas = hidden.get_deltas_terms(nodes)
        self._etas   = hidden.get_etas_terms(nodes)
